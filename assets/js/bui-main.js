...
function bat1() {
  ...
  const cardImages = [
    "./assets/image/dos1.svg",
    "./assets/image/dos2.svg",
    "./assets/image/dos3.svg",
  ];
  const namesImages = [
    "Агурские водопады",
    "Водопад Поликаря",
    "Водопад Плачущие скалы",
  ];
  ...
  filterButtons.forEach((button) => {
    button.addEventListener("click", function () {
      ...
      items.forEach((item) => {
        ...
        if (
          filterValue === "all" ||
          item.getAttribute("data-name") === filterValue
        ) {
...
function bat2() {
  ...
  const cardImages = [
    "./assets/image/btn21.svg",
    "./assets/image/btn22.svg",
    "./assets/image/btn23.svg",
  ];
  const namesImages = [
    "Дагомысские корыта",
    "Ореховский водопад",
    "Змейковидные водопады",
  ];
  const namesIClass = ["category1", "category1", "category2"];
